            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 bg-slate-900 hover:bg-slate-800 border border-slate-700 rounded-xl text-xs font-semibold text-white transition-all cursor-pointer"
                >
                  {user.photoURL ? (
                    <img
                      src={user.photoURL}
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-56 bg-slate-900 text-slate-100 rounded-xl shadow-2xl border border-slate-800 py-2 z-50 animate-in fade-in zoom-in-95">
                    ...
                    <div className="py-1">
                      {onOpenCloudResumesModal && (
                        <button
                          ...
                          className="w-full px-3.5 py-2 text-left text-xs text-slate-200 hover:bg-slate-800 flex items-center gap-2 font-medium cursor-pointer"
                        >
                    ...
                    <div className="border-t border-slate-800 pt-1 mt-1">
                      <button
                        ...
                        className="w-full px-3.5 py-2 text-left text-xs text-rose-400 hover:bg-slate-800 flex items-center gap-2 font-semibold cursor-pointer"
                      >
              ...
              onOpenAuthModal && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-200 hover:text-white bg-slate-900 border border-slate-700 hover:border-slate-600 transition-all cursor-pointer"
                >
